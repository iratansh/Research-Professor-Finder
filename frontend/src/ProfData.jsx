	...
	return (
		<div className="prof-data-page">
			...
			<div className="prof-info">
				...
				<p>
					<strong>Email:</strong> <a href={`mailto:${professor.email}`}>{professor.email || "N/A"}</a>
				</p>
				<p>
			...
			<div className="prof-bio">
				...
				{professor.html_overview ? (
					<div dangerouslySetInnerHTML={{ __html: professor.html_overview }} className="prof-html-content" />
				) : (
